...
class topairing extends StatefulWidget {
  const topairing({Key? key}) : super(key: key);

  @override
  State<topairing> createState() => _topairingState();
}

class _topairingState extends State<topairing> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: topAiringAnimeList.isEmpty
          ? Center(child: CircularProgressIndicator())
          : ListView.builder(
              physics: ClampingScrollPhysics(),
              itemCount: topAiringAnimeList.length > 50
                  ? 50
                  : topAiringAnimeList.length,
              itemBuilder: (context, index) {
                Map<String, dynamic> animeData = topAiringAnimeList[index];
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          CustomButton(Icons.info_outline, "See more", () {
